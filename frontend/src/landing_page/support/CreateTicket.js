  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="text-center text-muted fs-2 mb-5">To create a ticket, select a relevant topic</h1>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="mb-4">
            <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Kite
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="mb-4">
            <i class="fa fa-creative-commons" aria-hidden="true"></i> Coin
          </h4>
          ...
          <a href="" style={{textDecoration:'none',lineHeight:'2.5'}} >Fixed Deposite</a><br/>
          <a href="" style={{textDecoration:'none',lineHeight:'2.5'}} >Features on Coin</a><br/>
          <a href="" style={{textDecoration:'none',lineHeight:'2.5'}} >Payments and Order</a><br/>
          <a href="" style={{textDecoration:'none',lineHeight:'2.5'}} >General</a><br/>
        </div>
      </div>
    </div>
